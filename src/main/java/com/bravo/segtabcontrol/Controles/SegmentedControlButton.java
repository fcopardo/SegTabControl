package com.bravo.segtabcontrol.Controles;
...
import com.bravo.segtabcontrol.R;
...
public class SegmentedControlButton extends RadioButton {
    ...
    public void init(AttributeSet attrs, int defStyle) {
        if (attrs != null) {
            ...
            mTextAllCaps = a.getBoolean(R.styleable.SegmentedControlButton_customTextAllCaps, false);
